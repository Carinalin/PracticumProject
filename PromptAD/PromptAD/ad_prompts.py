...
class_state_abnormal = {
    ...
    'cigarette_box': ['{} with opened'],
    'drink_bottle': ['{} with cap half open', '{} with cap open', '{} with surface damage'],
    'drink_can': ['{} with deformation', '{} with straw missing', '{} with surface damage'],
    'food_bottle': ['{} with deformation', '{} with opened', '{} with surface damage'],
    'food_box': ['{} with deformation', '{} with opened', '{} with surface damage'],
    'food_package': ['{} with breakage', '{} with surface anomaly']
}