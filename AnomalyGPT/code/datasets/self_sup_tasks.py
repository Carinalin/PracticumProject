...
def patch_ex(ima_dest, ima_src=None, same=False, num_patches=1,
    ...
    Args:
        ...
        cutpaste_patch_generation (bool): optional, if set, width_bounds_pct, resize, skip_background, min_overlap_pct, min_object_pct, num_patches and gamma_params are ignored. A single patch is sampled as in the CutPaste paper: 
