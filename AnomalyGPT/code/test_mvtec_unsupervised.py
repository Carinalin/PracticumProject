...
for c_name in CLASS_NAMES:
    ...
    for root, dirs, files in os.walk(root_dir):
        for file in files:
            ...
            if "test" in file_path and 'png' in file and c_name in file_path and '.ipynb_checkpoints' not in root:
...
print(res)
res.to_csv ('../results/result_of_test_mvtec_unsupervised.csv',index=True)