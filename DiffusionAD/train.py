...
from data.dataset_beta_thresh import MVTecTrainDataset,MVTecTestDataset,VisATrainDataset,VisATestDataset,DAGMTrainDataset,DAGMTestDataset,MPDDTestDataset,MPDDTrainDataset, GoodsADTrainDataset, GoodsADTestDataset
...
def main():
    ...
    goodsad_class = ['drink_bottle', 'drink_can', 'food_bottle', 'food_box', 'food_package', 'cigarette_box']
    


    current_classes = goodsad_class
    ...
    for sub_class in current_classes:    
        ...
        if sub_class in visa_classes:
            ...
            class_type='DAGM'
        elif sub_class in goodsad_class:
            subclass_path = os.path.join(args["goodsad_root_path"],sub_class)
            training_dataset = GoodsADTrainDataset(
                subclass_path,sub_class,img_size=args["img_size"],args=args
                )
            testing_dataset = GoodsADTestDataset(
                subclass_path,sub_class,img_size=args["img_size"],
                )
            class_type='GoodsAD'            
